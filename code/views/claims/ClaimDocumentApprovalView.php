<div id="sbg-claim-entry" style="width:99%;margin: 5px 5px 5px 5px;">
	<div id="claim-tabs">
		<ul style="font-size: 0.8em;">
			<li><a href="#claim-document-header">Documents</a></li>
			<span class="sbg-tab-title">Claim Document Verification</span>
		</ul>
		<div id="claim-document-header" style="height:auto;text-align:left">
			<table>
				<tr>
			...
			<table id="document-list" class="sbg-table-list">
			</table>
		</div>
		
		<div class="ui-widget-content ui-corner-all" style="height:50px;margin-top:2px;" id='claimDocumentApprovalControlButton'>
			<div class="sbg-entry-error" style="width:300px;">
				<span id="claim_err_mesg" class="sbg-error"></span>
			</div>
			<div class="sbg-entry-command">
				<input id="btnClaimDocumentApprovalUpdate" type="button" value="Update"></input>
			</div>
		</div>
...
var claim_doc_approval_url = "<?php echo Util::convertLink("ClaimDocumentApproval") ; ?>" ;

<?php include (PATH_CODE . "js/claims/claimdocumentapproval.js") ; ?>
</script>