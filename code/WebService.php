...
{
	Log::write('[WebService]' . $e->getMessage(),"") ;
...
function fatalErrorShutdownHandler()
{
	...
	if ($last_error['type'] > 0)
		Log::write('[WebService]' . $last_error['message'] . " - " . $last_error['file'] . " on line " . $last_error['line']);
}
...
try {	
	...
	Log::write('[WebService]' . $e->getMessage(),$page) ;
}
if (!$called) {
