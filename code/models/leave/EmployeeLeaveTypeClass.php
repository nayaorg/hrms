<?php
require_once (PATH_TABLES . "leave/EmployeeLeaveTypeTable.php") ;

class EmployeeLeaveTypeClass {
	private $db ;
	private $tbl ;
	private $fldid ;
	function __construct($db) {
		$this->db = $db ;
		$this->tbl = EmployeeLeaveTypeTable::C_TABLE ;
		$this->fldid = EmployeeLeaveTypeTable::C_ID ;
	}
	function __destruct() {
	}
